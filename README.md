...
```
$ cd assignments-spring25/Assignment2/src/router
$ make
$ ./sr
```
...
---
## Reference Binary
To help you debug your topologies and understand the required behavior we provide a reference binary and you can find it at ```assignments-spring25/Assignment2/src/sr_solution``` (and `sr_solution_macm` for ARM Macs) in your directory. Instructions for how to use it are in the [Running the Emulation](#running-the-emulation) section above.
...
Zip up the files in your ```assignments-spring25/Assignment2/src/router``` folder by running the following command:
